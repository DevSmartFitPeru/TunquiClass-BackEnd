...
module.exports.handler = async (event) => {
    ...
    try {
        ...
        const queryValid = `UPDATE maestros_generales SET bit_borrado = TRUE, dt_fecha_eliminar ='${new Date().toISOString()}' , str_usuario_eliminar = '${obj_header.str_usuario}' WHERE int_id = ${obj_datos.int_id}`;
